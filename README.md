...
- `apps/whatsapp`: conector WhatsApp Business — **active** (inbound, status, webhook verification)
- `apps/instagram`: conector Instagram Business — **active** (inbound_messages, webhook_verification)
