...
> Nota: Status `active` não implica prontidão de produção; ver rubric em `TODO_list.md`. Use dedupe store compartilhado para evitar duplicidades em ambientes multi-instância.
